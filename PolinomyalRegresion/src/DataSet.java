...
public class DataSet {
    ...
    // Define arrays for x and y data sets
    ...
    // Define additional x and y data sets
    BigDecimal[] x2 = {
    ...
    // Define y data sets for additional x data sets
    BigDecimal[][] y3 = {
    ...
    // Constructor with parameters to initialize x and y data sets
    public DataSet(BigDecimal[] x, BigDecimal[][] y){
        this.y=y;
        this.x=x;
    }

    // Method to retrieve the y data set based on the specified index
    ...
    // Method to retrieve the x data set based on the specified index
